...
if (global.enemy < global.enemy_max && global.hell == 2 && (global.enemy + 8 <= global.enemy_max) &&  global.skeleton < Skeleton_max) {
	global.enemy += 8;
	global.skeleton += 8;
...
if (global.enemy < global.enemy_max && global.hell == 2 && global.wolfs < wolfs_max) {
	global.enemy += 1;
	global.wolfs += 1;
	instance_create_layer(random_range(1920, 14000), global.floor - 20, "Enemies", Wolf_o);
	if (i2 == 0) {
